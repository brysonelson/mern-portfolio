    ...
    return (
        <div className="container" id="home-top-space">
            <div className="sequenced socials">
                <Row>
                    <Col l={2} s={4} className="offset-l3 social-icon-col" id="socials">
                    ...
                    <Col l={2} s={4} className="social-icon-col">
                        <a href="https://github.com/brysonelson" className="waves-effect waves-light transition" target="_blank"><img src={require("../../images/github_PNG15.png")} width="100"></img></a>
                    </Col>
                    <Col l={2} s={4} className="social-icon-col" >
